...
```
USAGE
  $ paicku inspect IMAGENAME [--force-color] [--no-color] [-q] [--timestamps] [-v] [--bom]
    [--container-runtime docker|podman] [-h] [-o json|yaml|toml|human-readable]
...
FLAGS
  ...
  -o, --output=<option>             [default: human-readable] Output format to display builder detail.
      ...
      --container-runtime=<option>  Specify container runtime to inspect your image.
...
_See code: [src/commands/inspect/index.ts](https://github.com/nodeshift/paicku/blob/v0.2.0/src/commands/inspect/index.ts)_
